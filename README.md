...
git commit -m "Add my-awesome-bot"
git push origin bot/your-name
```

Then open a Pull Request on GitHub -- your bot will be entered into the tournament once your PR is merged!
